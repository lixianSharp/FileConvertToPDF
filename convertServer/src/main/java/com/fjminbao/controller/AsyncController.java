...
import com.fjminbao.dto.RequestDTO;
...
public class AsyncController {
    ...
    public ResponseDTO convertToPdf(HttpServletRequest request) throws IOException {
        ...
        //fileDestPathName:文件上传在 http://www.fjminbaoscp.com:8085/upload/ 中之后的路径，例如源文件在文件服务器中的全路径为："http://www.fjminbaoscp.com:8085/upload/convertToPdfDir/20200609/P/Pppt20200609082825561.pdf" 则fileDestPathName的值就为: "convertToPdfDir/20200609/P/Pppt20200609082825561.pdf"
        String fileName = request.getParameter("fileDestPathName");//   convertToPdfDir/20200609/P/Pppt20200609082825561.pdf
        ...
        String originFleFullPath = originFilePath + fileName;//  http://www.fjminbaoscp.com:8085/upload/convertToPdfDir/20200609/P/Pppt20200609082825561.pdf
